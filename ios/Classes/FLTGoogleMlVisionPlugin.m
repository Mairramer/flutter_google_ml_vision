...
@implementation FLTGoogleMlVisionPlugin
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  ...
  FlutterMethodChannel *channel =
      [FlutterMethodChannel methodChannelWithName:@"plugins.flutter.brianmtully.com/google_ml_vision"
                                  binaryMessenger:[registrar messenger]];
  FLTGoogleMlVisionPlugin *instance = [[FLTGoogleMlVisionPlugin alloc] init];
...
- (void)handleDetection:(FlutterMethodCall *)call result:(FlutterResult)result {
  ...
  if (!detector) {
    ...
    [FLTGoogleMlVisionPlugin addDetector:handle detector:detector];
  }
